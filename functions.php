...
function sanctuary_scripts() {
  ...
  wp_enqueue_script( 'scrollorama', get_template_directory_uri() . '/js/jquery.scrollorama.js', array('jquery'), '20140308', true );
  wp_enqueue_script( 'scrolldeck', get_template_directory_uri() . '/js/jquery.scrolldeck.js', array('jquery'), '20140308', true );
  wp_enqueue_script( 'jquery-easing', get_template_directory_uri() . '/js/jquery.easing.1.3.js', array('jquery'), '20140308', true );
}
